...
# Make a bar plot with standard deviation error bars for the three criteria levels
labels = ['Criteria: 0.5m for 2 seconds', 'Criteria: 0.2m for 2 seconds', 'Criteria: 0.2m for 4 seconds']
x = np.arange(len(labels))
width = 0.18
gap_between_pairs = 0.02
fig, ax = plt.subplots(figsize=(10, 5))

series = [
    ('NMPC - Y-axis', [mean_y_nmpc_very_relaxed, mean_y_nmpc_relaxed, mean_y_nmpc], [std_y_nmpc_very_relaxed, std_y_nmpc_relaxed, std_y_nmpc], -1.5 * width - gap_between_pairs / 2, 'tab:blue', 1.0, None, [nmpc_succesfull_y_very_relaxed, nmpc_succesfull_y_relaxed, nmpc_succesfull_y], nmpc_total),
    ('PX4 - Y-axis', [mean_y_px4_very_relaxed, mean_y_px4_relaxed, mean_y_px4], [std_y_px4_very_relaxed, std_y_px4_relaxed, std_y_px4], -0.5 * width - gap_between_pairs / 2, 'tab:orange', 1.0, None, [px4_succesfull_y_very_relaxed, px4_succesfull_y_relaxed, px4_succesfull_y], px4_total),
    ('NMPC - Euclidean', [mean_xy_nmpc_very_relaxed, mean_xy_nmpc_relaxed, mean_xy_nmpc], [std_xy_nmpc_very_relaxed, std_xy_nmpc_relaxed, std_xy_nmpc], 0.5 * width + gap_between_pairs / 2, 'tab:blue', 1.0, '//', [nmpc_succesfull_xy_very_relaxed, nmpc_succesfull_xy_relaxed, nmpc_succesfull_xy], nmpc_total),
    ('PX4 - Euclidean', [mean_xy_px4_very_relaxed, mean_xy_px4_relaxed, mean_xy_px4], [std_xy_px4_very_relaxed, std_xy_px4_relaxed, std_xy_px4], 1.5 * width + gap_between_pairs / 2, 'tab:orange', 1.0, '//', [px4_succesfull_xy_very_relaxed, px4_succesfull_xy_relaxed, px4_succesfull_xy], px4_total),
]
...
ax.set_title('Mean Settling Time after Emergency Stop', fontsize=16)
ax.set_xticks(x)
...
plt.tight_layout()
plt.savefig('figures/estop_settling_times_comparison.png', dpi=300)
plt.show()